...
(function () {
  ...
  const REASONS = {
    ...
    'mentorship-cv':             { subject: 'Match Mentorship: Personal Statement Review',   category: 'booking' },
    'mentorship-mock-interview': { subject: 'Match Mentorship: Mock Interview Session',    category: 'booking' },
    'mentorship-eras':           { subject: 'Match Mentorship: ERAS CV Review', category: 'booking' },
